...
let funItems = ["Ride horse", "Go beach", "Visit friends"];

let weekendItems = ["Pull weeds", "Transplant starters", "Attend Chicken Cohort Class"];
...
app.get("/fun", function(req, res){
  ...
  let day = date.getDate();
    res.render("list", {listTitle: "Fun Items MUST Do List", newListItems: funItems})
});
